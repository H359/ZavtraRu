...
instance Yesod App where
    ...
    defaultLayout widget = do
        master <- getYesod
        mmsg <- getMessage
        hotBundles <- runDB $ selectList [TagsBundleIsHot ==. True] [Desc TagsBundleTitle]
...
instance YesodAuth App where
    ...
    authHttpManager = error "Email doesn't need an HTTP manaer"
...
Пожалуйста, подтвердите ваш e-mail нажав ссылку ниже.
...
<p>Пожалуйста, подтвердите ваш e-mail нажав ссылку ниже.
<p>
