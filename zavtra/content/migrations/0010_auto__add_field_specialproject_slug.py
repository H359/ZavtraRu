...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SpecialProject.slug'
        db.add_column(u'content_specialproject', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(default='', unique=True, max_length=256, populate_from='title', unique_with=()),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SpecialProject.slug'
        db.delete_column(u'content_specialproject', 'slug')
    ...
    models = {
        ...
        u'content.specialproject': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('autoslug.fields.AutoSlugField', [], {'unique': 'True', 'max_length': '256', 'populate_from': "'title'", 'unique_with': '()'}),
