...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Rubric.in_rubricator'
        db.add_column(u'content_rubric', 'in_rubricator',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Rubric.in_rubricator'
        db.delete_column(u'content_rubric', 'in_rubricator')
