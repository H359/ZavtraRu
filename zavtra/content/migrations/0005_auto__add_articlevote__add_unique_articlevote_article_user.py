...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ArticleVote'
        db.create_table(u'content_articlevote', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('article', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['content.Article'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['siteuser.User'])),
            ('is_upvote', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'content', ['ArticleVote'])

        # Adding unique constraint on 'ArticleVote', fields ['article', 'user']
        db.create_unique(u'content_articlevote', ['article_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ArticleVote', fields ['article', 'user']
        db.delete_unique(u'content_articlevote', ['article_id', 'user_id'])

        # Deleting model 'ArticleVote'
        db.delete_table(u'content_articlevote')
    ...
    models = {
        ...
        u'content.articlevote': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_upvote': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
