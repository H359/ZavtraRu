...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExtractedQuote'
        db.create_table(u'content_extractedquote', (
        ...
        db.send_create_signal('content', ['ExtractedQuote'])


    def backwards(self, orm):
        # Deleting model 'ExtractedQuote'
        db.delete_table(u'content_extractedquote')
    ...
    models = {
        'content.article': {
            ...
            'published_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 18, 0, 0)'}),
        ...
        'content.extractedquote': {
            'Meta': {'object_name': 'ExtractedQuote'},
        ...
        'content.specialproject': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 18, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('autoslug.fields.AutoSlugField', [], {'unique': 'True', 'max_length': '1024', 'populate_from': "'title'", 'unique_with': '()'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '1024'})
        },
        ...
        u'siteuser.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 18, 0, 0)'}),
