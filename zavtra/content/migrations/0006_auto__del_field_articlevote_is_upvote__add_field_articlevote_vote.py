...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ArticleVote.is_upvote'
        db.delete_column(u'content_articlevote', 'is_upvote')

        # Adding field 'ArticleVote.vote'
        db.add_column(u'content_articlevote', 'vote',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ArticleVote.is_upvote'
        db.add_column(u'content_articlevote', 'is_upvote',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'ArticleVote.vote'
        db.delete_column(u'content_articlevote', 'vote')
