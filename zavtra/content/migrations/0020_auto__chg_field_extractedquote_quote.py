...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExtractedQuote.quote'
        db.alter_column(u'content_extractedquote', 'quote', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'ExtractedQuote.quote'
        db.alter_column(u'content_extractedquote', 'quote', self.gf('django.db.models.fields.TextField')())
