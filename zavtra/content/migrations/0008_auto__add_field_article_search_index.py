...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.search_index'
        db.add_column(u'content_article', 'search_index',
                      self.gf('djorm_pgfulltext.fields.VectorField')(default='', null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.search_index'
        db.delete_column(u'content_article', 'search_index')
    ...
    models = {
        u'content.article': {
            ...
            'published_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 23, 0, 0)'}),
        ...
        u'content.dailyquote': {
            ...
            'day': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 2, 23, 0, 0)', 'unique': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'siteuser.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 23, 0, 0)'}),
