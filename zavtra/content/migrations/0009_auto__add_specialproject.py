...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SpecialProject'
        db.create_table(u'content_specialproject', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 3, 1, 0, 0))),
        ))
        db.send_create_signal(u'content', ['SpecialProject'])

        # Adding M2M table for field articles on 'SpecialProject'
        db.create_table(u'content_specialproject_articles', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('specialproject', models.ForeignKey(orm[u'content.specialproject'], null=False)),
            ('article', models.ForeignKey(orm[u'content.article'], null=False))
        ))
        db.create_unique(u'content_specialproject_articles', ['specialproject_id', 'article_id'])


    def backwards(self, orm):
        # Deleting model 'SpecialProject'
        db.delete_table(u'content_specialproject')

        # Removing M2M table for field articles on 'SpecialProject'
        db.delete_table('content_specialproject_articles')
    ...
    models = {
        u'content.article': {
            ...
            'published_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 1, 0, 0)'}),
        ...
        u'content.articlevote': {
            'Meta': {'unique_together': "(('article', 'user'),)", 'object_name': 'ArticleVote'},
            'article': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'votes'", 'to': u"orm['content.Article']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'content.dailyquote': {
            ...
            'day': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 1, 0, 0)', 'unique': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'content.rubricinissue': {
            ...
            'position': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'rubric': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'issue_rubrics'", 'to': u"orm['content.Rubric']"})
        },
        u'content.specialproject': {
            'Meta': {'object_name': 'SpecialProject'},
            'articles': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['content.Article']", 'symmetrical': 'False'}),
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 1, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
