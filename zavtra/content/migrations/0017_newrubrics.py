...
class Migration(DataMigration):
    new_rubrics = (
        {'title': u'Объявления', 'slug': 'announcements'},
        {'title': u'Письма в редакцию', 'slug': 'letters'},
        {'title': u'Блог "Изборский клуб"', 'slug': 'izborsky_club'}
    )

    def forwards(self, orm):
        "Write your forwards methods here."
        for r in self.new_rubrics:
            rubric = orm['content.Rubric'](**r)
            rubric.save()

    def backwards(self, orm):
        for r in self.new_rubrics:
            orm['content.Rubric'].objects.get(slug=r['slug']).delete()
    ...
    models = {
        'content.article': {
            ...
            'published_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 19, 0, 0)'}),
        ...
        'content.specialproject': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 19, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('autoslug.fields.AutoSlugField', [], {'unique': 'True', 'max_length': '1024', 'populate_from': "'title'", 'unique_with': '()'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '1024'})
        },
        ...
        u'siteuser.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 19, 0, 0)'}),
