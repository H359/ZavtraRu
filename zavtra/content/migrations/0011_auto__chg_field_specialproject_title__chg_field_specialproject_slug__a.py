...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SpecialProject.title'
        db.alter_column(u'content_specialproject', 'title', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'SpecialProject.slug'
        db.alter_column(u'content_specialproject', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique=True, max_length=1024, populate_from='title', unique_with=()))
        # Adding field 'Article._issue'
        db.add_column(u'content_article', '_issue',
                      self.gf('django.db.models.fields.IntegerField')(default=-1),
                      keep_default=False)


        # Changing field 'Article.slug'
        db.alter_column(u'content_article', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique=True, max_length=1024, populate_from='title', unique_with=()))

    def backwards(self, orm):

        # Changing field 'SpecialProject.title'
        db.alter_column(u'content_specialproject', 'title', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'SpecialProject.slug'
        db.alter_column(u'content_specialproject', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=256, unique_with=(), unique=True, populate_from='title'))
        # Deleting field 'Article._issue'
        db.delete_column(u'content_article', '_issue')


        # Changing field 'Article.slug'
        db.alter_column(u'content_article', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=1024, unique_with=(), unique=True, populate_from=None))
    ...
    models = {
        'content.article': {
            ...
            'published_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 3, 0, 0)'}),
        ...
        'content.dailyquote': {
            ...
            'day': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 3, 0, 0)', 'unique': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'content.specialproject': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 3, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('autoslug.fields.AutoSlugField', [], {'unique': 'True', 'max_length': '1024', 'populate_from': "'title'", 'unique_with': '()'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '1024'})
        },
        ...
        u'siteuser.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 3, 0, 0)'}),
