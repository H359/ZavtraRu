...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WodCite'
        db.create_table(u'content_wodcite', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('article', self.gf('django.db.models.fields.related.ForeignKey')(related_name='cites', to=orm['content.Article'])),
            ('word', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('cite', self.gf('django.db.models.fields.TextField')()),
            ('source', self.gf('django.db.models.fields.CharField')(max_length=1024)),
        ))
        db.send_create_signal(u'content', ['WodCite'])


    def backwards(self, orm):
        # Deleting model 'WodCite'
        db.delete_table(u'content_wodcite')
    ...
    models = {
        u'content.article': {
            ...
            'published_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 20, 0, 0)'}),
        ...
        u'content.dailyquote': {
            ...
            'day': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 2, 20, 0, 0)', 'unique': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'siteuser.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 20, 0, 0)'}),
